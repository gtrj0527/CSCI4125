...
CREATE TABLE company_specialty (
    specialty_id number GENERATED ALWAYS AS IDENTITY NOT NULL PRIMARY KEY,
    comp_id number(8) NOT NULL,
    comp_name varchar(255) NOT NULL,
    specialty varchar(8) NOT NULL
--    FOREIGN KEY comp_id REFERENCES company(comp_id),
--    FOREIGN KEY comp_name REFERENCES company(comp_id)
...
CREATE TABLE position(
    pos_code NUMBER GENERATED ALWAYS AS IDENTITY START WITH 0001 NOT NULL PRIMARY KEY,
    comp_id number(8) NOT NULL,
...
insert into position(comp_id,pos_title,emp_mode,primary_skill,pay_rate) values (1111,'developer','ft','sql',3600.50);
